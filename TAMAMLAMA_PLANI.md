...
> (ayrıntılar maddelerin altında); regresyon **118/118 PASS** (dev) + yerel prod ve
...
- **C7.** Lansman öncesi **regresyon**: tüm E2E paketlerini (yetki/feed/stok/kupon/banner/B2B 53) tek seferde koş.
  ...
  **118/118** (2026-08-17; XVIII +7: üç girişte oturum-ID dönüşü, misafir-sepet transfer/devri
  + XX +1: eski-çerez sabitleme pruebası + XXII +1: CSRF-403 sözleşmesi + XXIII +1: CSRF
  çerezi SameSite=Lax + XXV +4: kullanıcı sipariş atıflaması).
