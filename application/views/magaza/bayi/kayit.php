...
<section class="auth-sarma">
    <div class="auth-kart">
        ...
        <h1 class="auth-baslik">Bayi Hesabı Oluştur</h1>
        <p class="auth-alt">Toptan fiyatlar, minimum sipariş ve XML/API erişimi için kaydolun.</p>
        ...
        <form action="<?= site_url('bayi/kayit_kaydet') ?>" method="post">
            <?= csrf_field() ?>
            <div class="odeme-alan"><label>Ad Soyad / Yetkili <span class="zor">*</span></label><input type="text" name="yetkili_ad_soyad" value="<?= set_value('yetkili_ad_soyad') ?>" required maxlength="120"></div>
            <div class="odeme-alan"><label>Firma Ünvanı <span class="zor">*</span></label><input type="text" name="firma_adi" value="<?= set_value('firma_adi') ?>" required maxlength="160"></div>
            <div class="odeme-alan-2">
                ...
                <div class="odeme-alan"><label>Telefon <span class="zor">*</span></label><input type="tel" name="telefon" value="<?= set_value('telefon') ?>" required maxlength="30"></div>
            </div>
            <div class="odeme-alan-2">
                <div class="odeme-alan"><label>Vergi / TC No</label><input type="text" name="vergi_no" value="<?= set_value('vergi_no') ?>" maxlength="30"></div>
                <div class="odeme-alan"><label>Vergi Dairesi</label><input type="text" name="vergi_dairesi" value="<?= set_value('vergi_dairesi') ?>" maxlength="120"></div>
            </div>
            <div class="odeme-alan-2">
        ...
        <p class="auth-link">Zaten hesabın var mı? <a href="<?= site_url('bayi/giris') ?>">Giriş yap →</a></p>
    </div>
</section>
