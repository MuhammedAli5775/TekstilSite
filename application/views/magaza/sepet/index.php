    ...
    <div class="sepet-layout">
        ...
        <div>
            <div class="sepet-ozet">
                ...
                <div class="sepet-ozet-satr"><span>Ara toplam</span><span><?= para_formatla($pb_ara_toplam, $pb) ?></span></div>
                <div class="sepet-ozet-satr"><span>Kargo</span><span><?= $ara_toplam >= $esik ? 'Ücretsiz' : 'Ödeme adımında' ?></span></div>
                <?php if ($ara_toplam < $esik): ?>
                    <div class="sepet-ozet-satr" style="font-size:12px;color:var(--steel)"><span><?= para_goster($esik - $ara_toplam, $pb) ?> daha → ücretsiz kargo</span><span></span></div>
                <?php endif; ?>
                <div class="sepet-ozet-toplam"><span>Toplam</span><span><?= para_formatla($pb_ara_toplam, $pb) ?></span></div>
