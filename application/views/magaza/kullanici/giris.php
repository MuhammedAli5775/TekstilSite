...
<section class="auth-sarma">
    <div class="auth-kart auth-kart--dar">
        ...
        <h1 class="auth-baslik">Kullanıcı Girişi</h1>
        <p class="auth-alt">Siparişlerinizi takip etmek için giriş yapın.</p>
        ...
        <p class="auth-link">Hesabın yok mu? <a href="<?= site_url('kullanici/kayit') ?>">Kayıt ol →</a></p>
        <p class="auth-link"><small>Bayi misiniz? <a href="<?= site_url('bayi/giris') ?>">Bayi girişi</a></small></p>
    </div>
</section>
