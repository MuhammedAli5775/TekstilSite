                ...
                <?php foreach ($urunler as $u):
                    ...
                    <article class="prodcard">
                        <a class="prodcard__media" href="<?= site_url('urun/' . $u->slug) ?>" aria-label="<?= e($u->ad) ?>">
                            <?php if ($u->gorsel): ?><img src="<?= e(gorsel_url($u->gorsel)) ?>" alt="<?= e($u->ad) ?>" loading="lazy"><?php else: ?><div style="display:flex;align-items:center;justify-content:center;height:100%;color:var(--muted);font-size:13px">görsel yok</div><?php endif; ?>
                        </a>
